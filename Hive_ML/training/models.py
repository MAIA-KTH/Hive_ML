...
def decicion_tree(criterion: str = 'gini', max_depth: int = 10,
                  class_weight: Union[Dict, List] = None) -> DecisionTreeClassifier:
    """
...
def random_forest(n_estimators: int = 100, criterion: str = 'gini', max_depth: int = 10,
                  ...
                  max_samples: Union[int, float] = None) -> RandomForestClassifier:
    """
...
def svm_kernel(kernel: str = 'linear', poly_degree: int = 3, c_val: int = 1,
               class_weight: Union[Dict, List] = None) -> svm.SVC:
    """
...
def knn(neighbors=5) -> KNeighborsClassifier:
    """
...
def adab_tree(max_depth: int = 10, criterion: str = 'gini', class_weight: Union[Dict, List] = None,
              n_estimators: int = 100) -> AdaBoostClassifier:
    """
...
def qda() -> QuadraticDiscriminantAnalysis:
    """
...
def naive() -> naive_bayes.GaussianNB:
    """
