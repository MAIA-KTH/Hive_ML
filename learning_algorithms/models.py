...
def random_forest(n_estimators=100, criterion='gini', max_depth=10, class_weight=None):
    '''
    Parameters
    ----------
    n_estimators : int
...
def adab_tree(max_depth=10, criterion='gini', class_weight=None, n_estimators=100):
    '''
    Parameters
    ----------
    max_depth : int
