...
from loader_tools import get_filepath, get_id_label
from loader_tools import  read_nifti, get_subject_sequence
...
# Set writing path
cwd = os.getcwd()
feature_dir = os.path.join(cwd, 'features')
...
filename_xlsx = 'feature_set_full_new_batch.xlsx'
feature_file = os.path.join(feature_dir, filename_xlsx)



# Instantiating Radiomics Feature Extraction
extractor = featureextractor.RadiomicsFeatureExtractor()
param_path = os.path.join(os.getcwd(), 'radiomics_config/params.yaml')
